...
export function useMyFirstQueryQuery(options?: Omit<Urql.UseQueryArgs<MyFirstQueryQueryVariables>, 'query'>) {
  return Urql.useQuery<MyFirstQueryQuery>({ query: MyFirstQueryDocument, ...options });
};